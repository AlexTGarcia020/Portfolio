...
function Tecnologias () {
    ...
    <div className="container" >
        <div className='fondo-imagen shadow' style={{ backgroundImage: `url(${fondoImagen})` }} >
        </div>
        <div className='tecnologias-container'>
                    <h1 className='text-main-tecnologias text-white text-center' style={{fontFamily:""}}>Habilidades<strong className="strong-class"> ( skills )</strong></h1>
        </div>
        <div className="icons-media">
            ...
            <div className="text-white content-texts" style={{marginLeft:"42.6%"}}>
                ...
                <br />
                <h4 className="fs-4 text-hability">Habilidades Pricipales:</h4>
                <br/>
                <div class="skills">
                    <div>HTML5</div>
                    <div>CSS</div>
                ...
                <br />
                <h4 className="fs-4 mt-2">Idiomas:</h4>
                <br/>
                <div class="idiomas">
                    <div>Español : Nativo</div>
                    <div>Ingles : Intermedio</div>
                </div>
                <hr className="w-75 ms-5 hr-two text-white"/>
           </div>
    </div>
    )
}
